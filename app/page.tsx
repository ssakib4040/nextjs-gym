...
export default function page() {
  return (
    <>
      {/* // <!-- Navbar --> */}
      <nav className="bg-yellow-500 text-white py-4 px-8">
      ...
      {/* <section className="bg-yellow-400 py-20">
        <div className="container mx-auto text-center">
          ...
          <p className="text-xl text-gray-800">
            Get fit and stay healthy with our professional trainers.
          </p>
          <a
            href="#"
            className="mt-8 inline-block bg-yellow-600 text-white px-6 py-3 rounded-lg shadow-lg hover:bg-yellow-700"
          >
            Join Now
          </a>
        </div>
      ...
      {/* <!-- Footer --> */}
      <footer className="bg-yellow-500 text-white py-8 px-8">
        <div className="container mx-auto text-center">
